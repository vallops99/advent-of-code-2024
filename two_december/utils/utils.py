...
def normalize_to_csv():
    file = open("./two_december/data/data.txt", "r")
    ...
    file.close()
    csv = open("./two_december/data/data.csv", "w+")
...
def read_data() -> list[list[int]]:
    file = open("./two_december/data/data.csv", "r")
...
def check_result():
    result_file = open("./two_december/result/result.csv")
    result = result_file.readlines()
    result_file.close()

    brute_file = open("./two_december/result/brute_result.csv")
